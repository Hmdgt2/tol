...
RELATORIO_DUPLICADAS = os.path.join(RELATORIO_DIR, "funcoes_duplicadas_limpas.txt")
RELATORIO_EQUIVALENTES = os.path.join(RELATORIO_DIR, "funcoes_equivalentes_limpas.txt")
RELATORIO_SEMELHANTES = os.path.join(RELATORIO_DIR, "funcoes_semelhantes_limpas.txt")
RELATORIO_REORGANIZACAO = os.path.join(RELATORIO_DIR, "sugestoes_reorganizacao_limpas.txt")
