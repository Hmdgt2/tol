...
FUNCAO_CATEGORIA_MAP = {
    "algebra_categorias": ("AlgebraCategoriasWrapper", "Processar funções de algebra_categorias", "Feature extraction para pipeline de IA"),
    ...
    "analise_funcional": ("AnaliseFuncionalWrapper", "Processar funções de analise_funcional", "Feature extraction para pipeline de IA"),
    ...
    "analise_numerica_avancada": ("AnaliseNumericaAvancadaWrapper", "Processar funções de analise_numerica_avancada", "Feature extraction para pipeline de IA"),
    ...
    "combinatoria_avancada_1": ("CombinatoriaAvancada1Wrapper", "Processar funções de combinatoria_avancada_1", "Feature extraction para pipeline de IA"),
    ...
    "estatistica_multivariada_2": ("EstatisticaMultivariada2Wrapper", "Processar funções de estatistica_multivariada_2", "Feature extraction para pipeline de IA"),
    ...
    "funcoes_diversas": ("FuncoesDiversasWrapper", "Processar funções de funcoes_diversas", "Feature extraction para pipeline de IA"),
    ...
    "geometria_diferencial": ("GeometriaDiferencialWrapper", "Processar funções de geometria_diferencial", "Feature extraction para pipeline de IA"),
    "geometria_fractal": ("GeometriaFractalWrapper", "Processar funções de geometria_fractal", "Feature extraction para pipeline de IA"),
    ...
    "informacao_quantica": ("InformacaoQuanticaWrapper", "Processar funções de informacao_quantica", "Feature extraction para pipeline de IA"),
    ...
    "otimizacao_metaheuristicas": ("OtimizacaoMetaheuristicasWrapper", "Processar funções de otimizacao_metaheuristicas", "Feature extraction para pipeline de IA"),
    ...
    "processamento_sinais_avancado": ("ProcessamentoSinaisAvancadoWrapper", "Processar funções de processamento_sinais_avancado", "Feature extraction para pipeline de IA"),
    ...
    "sinais_nao_lineares": ("SinaisNaoLinearesWrapper", "Processar funções de sinais_nao_lineares", "Feature extraction para pipeline de IA"),
    "sistemas_dinamicos": ("SistemasDinamicosWrapper", "Processar funções de sistemas_dinamicos", "Feature extraction para pipeline de IA"),
    ...
    "teoria_medida": ("TeoriaMedidaWrapper", "Processar funções de teoria_medida", "Feature extraction para pipeline de IA"),
    ...
    "teoria_numeros_avancada": ("TeoriaNumerosAvancadaWrapper", "Processar funções de teoria_numeros_avancada", "Feature extraction para pipeline de IA"),
    "teoria_numeros_computacional": ("TeoriaNumerosComputacionalWrapper", "Processar funções de teoria_numeros_computacional", "Feature extraction para pipeline de IA"),
