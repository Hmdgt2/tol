...
def enviar_email_html(txt_path, remetente, senha_app, destinatario, assunto="Resultado Totoloto"):
    ...
    numeros_style = "font-family: 'Arial', monospace; font-size: 38px; color: #2E86C1; font-weight: bold;"
    ...
    <html lang="pt-PT">
      <body>
        ...
        <p style="{numeros_style} margin-top: 15px; letter-spacing: 10px; text-align: center;">
